package com.project.demo.vedioStreaming.controllers;
...
import com.project.demo.vedioStreaming.KafkaProducer;
...
import com.project.demo.vedioStreaming.service.CommentService;
import com.project.demo.vedioStreaming.service.GenreService;
import com.project.demo.vedioStreaming.service.LikeService;
import com.project.demo.vedioStreaming.service.UserService;
import com.project.demo.vedioStreaming.service.VideoService;
...
public class VideoMetadataController {
    ...
    public String iframes(@PathVariable("videoId") int videoId,Model m){
        m.addAttribute("videoId",videoId);
        m.addAttribute("user", user); 
        m.addAttribute("comments",cs.getAllComments(videoId));
        return "comment";
    }
